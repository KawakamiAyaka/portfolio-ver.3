        ...
        <main>
            ...
            <div className={styles.NoteBox}>
                <div className={styles.NotePage}>
                    ...
                    <Learned
                        head="装飾と情報のバランス設計"
                        text={`図鑑画面やスマホを横に倒す指示画面で、直感的に操作を伝えるためにモチーフを多用しましたが、装飾と情報の存在感が同等になり視認性が下がる課題がありました。実装後の画面を確認する中でその問題に気づき、情報・機能・装飾のバランスを意識した設計の重要性を実感しました。今後はシンプルでも直感的に伝わる構図や余白・配色・レイアウトを研究し、UI全体で世界観を表現できるよう学んでいきたいです。`}
                    />
