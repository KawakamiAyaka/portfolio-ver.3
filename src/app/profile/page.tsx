                    ...
                    <div className={styles.ProfileBox}>
                        ...
                        <div className={styles.Introductions}>
                            ...
                            <p className={styles.H3}>
                                “自分の手で、誰かの心を動かせるものをつくりたい。”
                            </p>
                            <p className={styles.Text}>
                                その想いの原点は、子どもの頃に夢中になっていた「ものづくり」と「パソコン」。
                                <br />
                                この2つが組み合わさった、Webデザインという世界に惹かれました。
                                今は、感情を通じて問題を解決し、相手の心に届く体験をつくることを大切にしています。
                                将来は、チームやクライアントと学び合いながら、共に成長できるデザイナーを目指しています。{" "}
                            </p>
                            <Image
                                className={styles.MyImage}
                                src="/Hobby.svg"
